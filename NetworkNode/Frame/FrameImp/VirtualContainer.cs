...
namespace NetworkNode.SDHFrame
{
    ...
    public class VirtualContainer : IContent
    {
        ...
        public static int GetLowLevelSdhIndex(int contentIndex, VirtualContainerLevel level)
        {
            int usedSpace = -1;
            switch(level) {
            ...
            return contentIndex / usedSpace;
        }

        public static string GetTU(VirtualContainerLevel level)
        {
            switch (level)
            {
                case VirtualContainerLevel.VC12:
